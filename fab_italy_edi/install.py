...
def get_purchase_invoice_custom_fields() -> list[dict[str, object]]:
	return [
		...
		},
		{
			...
			"label": _("SDI Reception Date"),
			"fieldtype": "Date",
			"insert_after": "fab_edi_transmission_date",
			"read_only": 1,
			"allow_on_submit": 1,
			"description": _("Date SDI delivered this invoice to us: the legal reference for payment terms, not the supplier's invoice date."),
		},
		{
